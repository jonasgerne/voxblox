### \[About this fork\]
WIP: In addition to the `voxblox_msgs/Mesh` mesh message, this node can publish the full mesh as a `mesh_msgs/TriangleMeshStamped` message [(see mesh_tools)](https://github.com/uos/mesh_tools) on request.
